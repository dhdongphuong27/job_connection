...
@section('content')
<div class="container">
    <form action = "/project/save/{{$project->id}}" enctype="multipart/form-data" method = "post">
        @csrf
        @method('PATCH');
        <div class="row">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                <div class="form-group row">
                    ...
                    <input value="{{$project->name }}" id="name" type="text" 
        ...
        <div class="row">
            <div class="col-8 offset-2">
                <div class="form-group row">
                    ...
                    <textarea rows="5" name = "detail"  class = "form-control" id = "detail">{{$project->detail}}</textarea>
        ...
        <div class="row">
            <div class="col-8 offset-2">
                <div class="form-group row">
                    ...
                    <textarea rows="5" name = "required_skill"  class = "form-control" id = "required_skill">{{$project->required_skill}}</textarea>
                    <div class="substitle" style = "font-weight: 400;
                        font-size: 13px;color: #bbb;white-space: initial;padding-top: 
        ...
        <div class="row">
            <div class="col-8 offset-2 ">
                <div class="input-group-prepend">
                    ...
                    <input value = "{{$project->minsalary}}" name = "minsalary"  class = "" id = "minsalary">
                    <input value = "{{$project->maxsalary}}" name = "maxsalary"  class = "" id = "minsalary">
                    @error('description')
                        <strong style = "color:red">{{ $message }}</strong>
                    @enderror  
                </div> 
        ...
        <div class="row">
            <div class="col-8 offset-2">
                <div class="form-group row">
                    ...
                    <input type="text" value = "{{$project->companyinfo}}" name = "companyinfo"  class = "form-control" id = "companyinfo"></input>
                    @error('companyinfo')
                        <strong style = "color:red">{{ $message }}</strong>
                    @enderror  
                </div> 
        ...
        <div class="row">
            <div class="col-8 offset-2">
                <div class="form-group row">
                    ...
                    <input type="text" value = "{{$project->contactemail}}" name = "contactemail"  class = "form-control" id = "contactemail">
                    @error('contactemail')
                        <strong style = "color:red">{{ $message }}</strong>
                    @enderror  
                </div> 
